...
let XLSXurl = 'data/data_sankeydiagram_ESA_v24072025.xlsm'
 ...
 input.addEventListener('change', async (event) => {
   ...
   try {
    ...
    //  alert('Excel data extracted — check the console!');
     ...
     // GENERATE SANKEY
     var rawSankeyData = generateSankeyLibrary(jsonToWorkbook(excelData.data_sankeydiagram_ESA_v24072025))
     sankeyConfigs.forEach(element => {
