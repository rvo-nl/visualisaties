...
let XLSXurl = 'data/data_sankeydiagram_adapttransform_2024_desparsed.xlsm'
...
//  label.textContent = 'Select a ZIP file containing Excel files:';
 ...
 input.addEventListener('change', async (event) => {
   ...
   try {
     ...
     dataset_ADAPT = excelData['data_watervaldiagram_ADAPT']
     dataset_TRANSFORM_DEFAULT = excelData['data_watervaldiagram_TRANSFORM - Default']
     dataset_TRANSFORM_C_EN_I = excelData['data_watervaldiagram_TRANSFORM - Competitief en import']
     dataset_TRANSFORM_MC = excelData['data_watervaldiagram_TRANSFORM - Minder competitief']
     dataset_TRANSFORM_MC_EN_I = excelData['data_watervaldiagram_TRANSFORM - Minder competitief en import']
    ...
    //  alert('Excel data extracted — check the console!');
     ...
     // GENERATE SANKEY
     var rawSankeyData = generateSankeyLibrary(jsonToWorkbook(excelData.data_sankeydiagram_adapttransform_2024_desparsed))
     sankeyConfigs.forEach(element => {
