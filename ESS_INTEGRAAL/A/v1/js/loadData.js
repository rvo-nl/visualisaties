...
let XLSXurl = 'data/data_sankeydiagram_tnoimplement.xlsm'
 ...
 input.addEventListener('change', async (event) => {
   ...
   try {
    ...
    //  alert('Excel data extracted — check the console!');
     ...
     // GENERATE SANKEY
     var rawSankeyData = generateSankeyLibrary(jsonToWorkbook(excelData.data_sankeydiagram_integraal_desparsed))
     sankeyConfigs.forEach(element => {
