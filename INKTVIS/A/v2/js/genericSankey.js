...
function initSankey (config) {
  ...
  function process_xlsx (config) {
    if (dataSource == 'url') {
      ...
      readExcelFile(config.xlsxURL, (links, nodes, legend, settings, remarks, dummydata, dataset_grafieken) => {
  ...
  function drawSankey (sankeyDataInput) {
    ...
    function drawScenarioButtons () {
      let scenarios = [
        {id: 'OP.CCS.40', title: 'OP.CCS.40'},
        {id: 'OptimistischSelectiefFossilCarbonPenalty', title: 'OptimistischSelectiefFossilCarbonPenalty'},
        {id: 'PP.CCS.30.in.2050', title: 'PP.CCS.30.in.2050'}
    ...
    function drawWACCButtons () {
      let waccs = [
        ...
        {id: 'wacc_verhoogd', title: 'Verhoogd (4% - 8%)'}
  ...
  function readExcelFile (url, callback) {
    ...
    xhr.onload = () => {
      ...
      callback(links, nodes, legend, settings, remarks, dummydata, dataset_grafieken)
    }
