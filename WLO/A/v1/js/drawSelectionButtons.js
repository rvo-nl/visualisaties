...
function drawSelectionButtons (config) {
  ...
  function drawScenarioButtons () {
    let scenarios = [
      ...
      {id: 'WLO3', title: 'WLO 3'},
      {id: 'WLO4', title: 'WLO 4'},
      {id: 'PR40', title: 'TVKN Pragmatisch Ruim 40'},
      {id: 'SR20', title: 'TVKN Specifiek Ruim 20'},
      {id: 'PB30', title: 'TVKN Pragmatisch Beperkt 30'},
  ...
  function drawYearButtons () {
    ...
    years.forEach((year, index) => {
      ...
      function updateButtonState() {
        ...
        const isLateYear = ['2055', '2060'].includes(year.id)
