...
let XLSXurl = 'data/data_sankeydiagram_desparsed.xlsm'
...
//  label.textContent = 'Select a ZIP file containing Excel files:';
 ...
 input.addEventListener('change', async (event) => {
   ...
   try {
    ...
    //  datasetPR40 = excelData['data_watervaldiagram_OP - CO2-opslag 40']
    //  datasetPB30 = excelData['data_watervaldiagram_PP_CCS_30_in_2050']
    //  datasetSR20 = excelData['data_watervaldiagram_OptimistischSelectiefFossilCarbonPenalty']
    //  datasetSRMPA = excelData['data_watervaldiagram_OS_minder plastic afval']
    //  datasetWLO1 = excelData['data_watervaldiagram_WLO1']
    //  datasetWLO2 = excelData['data_watervaldiagram_WLO2']
    //  datasetWLO3 = excelData['data_watervaldiagram_WLO3']
    //  datasetWLO4 = excelData['data_watervaldiagram_WLO4']
    //  initWaterfallDiagram()

    //  alert('Excel data extracted — check the console!');

     // GENERATE SANKEY
     var rawSankeyData = generateSankeyLibrary(jsonToWorkbook(excelData.data_sankeydiagram_desparsed))
     sankeyConfigs.forEach(element => {
