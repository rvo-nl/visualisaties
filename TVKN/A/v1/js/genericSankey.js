...
function initSankey (config) {
  ...
  function drawSankey (sankeyDataInput) {
    ...
    let scenarioIdLookup = {
      ...
      'OptimistischPragmatischFossilCarbonPenalty': {
        2030: 50,
        2035: 51,
        2040: 52,
        2045: 53,
      ...
      'overgang OP-OS bio hoog waterstof laag': {
        2030: 90,
        2035: 91,
        2040: 92,
        2045: 93,
      ...
      'overgang OP-OS bio laag waterstof hoog': {
        2030: 95,
        2035: 96,
        2040: 97,
        2045: 98,
      ...
      'Overgang OP-OS fossiel verbruik': {
        2030: 100,
        2035: 101,
        2040: 102,
        2045: 103,
      ...
      'Overgang OP-OS primair verbruik': {
        2030: 105,
        2035: 106,
        2040: 107,
        2045: 108,
      ...
      'Overgang OP-PP biogrondstoffen': {
        2030: 110,
        2035: 111,
        2040: 112,
        2045: 113,
      ...
      'PessimistischPragmatischFossilCarbonPenalty': {
        2030: 120,
        2035: 121,
        2040: 122,
        2045: 123,
      ...
      'PPP - bio en h2 laag - CCS 40 in 2050': {
        2030: 175,
        2035: 176,
        2040: 177,
        2045: 178,
    ...
    // SET DEFAULTS
    globalActiveScenario.id = 'OP - CO2-opslag 40'
    ...
    function drawScenarioButtons () {
      let scenarios = [
        {id: 'OP - CO2-opslag 40', title: '(1) OP-CO2-opslag 40'},
        {id: 'OP - CO2-opslag 50', title: '(2) OP-CO2-opslag 50'},
        {id: 'OP - geen kernenergie 2050', title: '(3) OP-geen kernenergie 2050'},
        {id: 'OP - methanolroute', title: '(4) OP-methanolroute'},
        {id: 'OP - minder warmtenetten', title: '(5) OP-minder warmtenetten'},
        {id: 'OP - mob conservatief', title: '(6) OP-mob conservatief'},
        {id: 'OP_CCS_30_in_2050', title: '(7) OP-OP_CCS_30_in_2050'},
        {id: 'OP_kern_30_in_2050', title: '(8) OP_kern_30_in_2050'},
        {id: 'OP_minder plastic afval', title: '(9) OP_minder plastic afval'},
        {id: 'OP_wind_hoog', title: '(10) OP_wind_hoog'},
        {id: 'OptimistischPragmatischFossilCarbonPenalty', title: '(11) OP_FossilCarbonPenalty'},
        {id: 'OptimistischSelectiefFossilCarbonPenalty', title: '(12) OS_FossilCarbonPenalty'},
        {id: 'OS - geen kernenergie 2050', title: '(13) OS-geen kernenergie 2050'},
        {id: 'OS - methanolroute', title: '(14) OS-methanolroute'},
        {id: 'OS_CCS_30_in_2050', title: '(15) OS_CCS_30_in_2050'},
        {id: 'OS_kern_30_in_2050', title: '(16) OS_kern_30_in_2050'},
        {id: 'OS_minder plastic afval', title: '(17) OS_minder plastic afval'},
        {id: 'OS_wind_hoog', title: '(18) OS_wind_hoog'},
        {id: 'overgang OP-OS bio hoog waterstof laag', title: '(19) OP-OS bio hoog waterstof laag'},
        {id: 'overgang OP-OS bio laag waterstof hoog', title: '(20) OP-OS bio laag waterstof hoog'},
        {id: 'Overgang OP-OS fossiel verbruik', title: '(21) OP-OS fossiel verbruik'},
        {id: 'Overgang OP-OS primair verbruik', title: '(22) OP-OS primair verbruik'},
        {id: 'Overgang OP-PP biogrondstoffen', title: '(23) OP-PP biogrondstoffen'},
        {id: 'Overgang OP-PP waterstof', title: '(24) OP-PP waterstof'},
        {id: 'PessimistischPragmatischFossilCarbonPenalty', title: '(25) PP_FossilCarbonPenalty'},
        {id: 'PP - CO2-opslag 40', title: '(26) PP-CO2-opslag 40'},
        {id: 'PP - CO2-opslag 50', title: '(27) PP-CO2-opslag 50'},
        {id: 'PP - geen kernenergie 2050', title: '(28) PP-geen kernenergie 2050'},
        {id: 'PP - methanolroute', title: '(29) PP-methanolroute'},
        {id: 'PP - minder warmtenetten', title: '(30) PP-minder warmtenetten'},
        {id: 'PP - mob conservatief', title: '(31) OP-PP-mob conservatief'},
        {id: 'PP_CCS_30_in_2050', title: '(32) PP_CCS_30_in_2050'},
        {id: 'PP_kern_30_in_2050', title: '(33) PP_kern_30_in_2050'},
        {id: 'PP_minder plastic afval', title: '(34) PP_minder plastic afval'},
        {id: 'PP_wind_hoog', title: '(35) PP_wind_hoog'},
        {id: 'PPP - bio en h2 laag - CCS 40 in 2050', title: '(36) PPP - bio en h2 laag - CCS 40 in 2050'}
      ]
